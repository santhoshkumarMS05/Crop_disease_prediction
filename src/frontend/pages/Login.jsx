...
const Login = ({ onLoginSuccess }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch("https://agroscan-backend-nu6s.onrender.com/auth/login", {
        method: "POST",
      ...
      <div className="flex bg-white rounded-3xl shadow-2xl overflow-hidden w-full max-w-6xl max-h-[95vh]">
          ...
          <div className="relative z-10 overflow-y-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-emerald-50 leading-relaxed">
                ...
                Upload images and get instant disease detection with professional treatment recommendations.
              </p>
            </div>
        ...
        <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 font-medium text-sm">Sign in to continue to your dashboard</p>
          </div>
          ...
          <div className="mt-6 flex items-center">
            ...
            <span className="px-4 text-xs text-gray-500 font-medium">Trusted by farmers worldwide</span>
            <div className="flex-1 border-t border-gray-200"></div>
          </div>
        </div>
      </div>
